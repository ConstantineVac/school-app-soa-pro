...
public class TeacherServiceImpl implements ITeacherService{
    ...
    private Teacher map(TeacherInsertDTO dto) {
        return new Teacher(null, dto.getFirstname(), dto.getLastname(), dto.getSsn(), dto.getUserId(), dto.getSpecialityId());
    }
    private Teacher map(TeacherUpdateDTO dto) {
        return new Teacher(dto.getId(), dto.getFirstname(), dto.getLastname(), dto.getSsn(),dto.getUserId(), dto.getSpecialityId());
    }
